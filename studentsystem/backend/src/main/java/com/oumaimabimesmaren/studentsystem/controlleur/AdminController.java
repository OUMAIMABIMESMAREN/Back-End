...
public class AdminController {
    ...
    public ResponseEntity<OrganizerResponseDTO> reviewOrganizerAccount(
            @PathVariable Long organizerId,
            @RequestParam boolean isApproved,
            @RequestParam Long adminId) {

        OrganizerResponseDTO response = adminService.reviewOrganizerAccount(organizerId, isApproved, adminId);
        return ResponseEntity.ok(response);
    }


    @PostMapping("/{adminId}/events/{eventId}/validate")
    public ResponseEntity<ValidationEventResponseDTO> validateEvent(
            @PathVariable Long eventId,
            @RequestParam boolean isValidated,
            @RequestParam Long adminId) {

        ValidationEventResponseDTO response = adminService.validateEventModifications(eventId, isValidated, adminId);
        return ResponseEntity.ok(response);
    }
    ...
    public ValidationEventResponseDTO validateNewEvent(
            @PathVariable Long eventId,
            @RequestParam boolean validate,
            @RequestParam Long adminId) {
        return adminService.validateNewEvent(eventId, validate, adminId);
    }
