    ...
    <footer className="site-footer">
      ...
      <div className="footer-container">
        ...
        <div className="footer-logo">
          ...
          <p>
            The platform connecting event enthusiasts and organizers since 2024. 
            Your gateway to the best university and cultural events.
          </p>
        ...
        <div className="footer-col">
          ...
          <ul>
            ...
            <li>Faculty of Sciences, Morocco</li>
          </ul>
        </div>
       ...
       <div className="footer-bottom">
        <p className="copyright">© 2025 GetUrTicket - All rights reserved</p>
